...
namespace ClientApi
{
    public class Startup
    {
        ...
        {
            var identityUrl = this._configuration.GetValue<string>("IdentityUrl");
            var idscope = this._configuration.GetValue<string>("IdentityScope");
            services.AddCors();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCors(builder =>
                 builder
                   .WithOrigins("http://localhost:8080", "https://localhost:44302", "http://localhost:8802")
                   .AllowAnyHeader()
                   .AllowAnyMethod()
                   .AllowCredentials()
               );
